module.exports = function(gopherApp) {
  ...
  /**
   * Handle schedul reminder action
   */
   ...
   *
   * NOTE: Much of this code is duplicated from
   * the initial email. Read about Composing
   * Gopher Skills for a more elegant solution.
   */
  gopherApp.on("task.reminder_due", function(gopher) {
    gopher.webhook.addEmail({
      to: gopher.get("source.from"),
